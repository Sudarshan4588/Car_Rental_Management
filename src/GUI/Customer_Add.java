...
public class Customer_Add {
    ...
    public Customer_Add() {
        ...
        CNIC_Label = new JLabel("Enter AadharNO (without dashes)");
                ...
                case "Add": {
                    ...
                    if (Customer.isCNICValid(cnic)) {
                        ...
                        if (customer == null) {
                            ...
                            JOptionPane.showMessageDialog(null, "This AadharNO is already registered !");
                        }
                    } else {
                        JOptionPane.showMessageDialog(null, "Invalid AadharNO");
                    }
                    break;
                }
                case "Cancel": {
