                        ...
                        if (Customer.isCNICValid(cnic)) {
                            ...
                            if (CO != null) {
                                if (cnic.equals(customer.getCNIC())) {
                                    ...
                                    cnic = null;
                                    JOptionPane.showMessageDialog(null, "This Aadhar is already registered !");
                                }
                            } else { // when Customer.SearchCNIC(M) returned null
                                System.out.println("new Aadhar is entered");
                            }
                        } else {
                            cnic = null;
                            CNICValidity_Label.setText("Invalid Aadhar !");
                        }
                    } else {
                        cnic = null;
                        CNICValidity_Label.setText("Enter Aadhar !");
                    }
                    if (!name.isEmpty()) {
