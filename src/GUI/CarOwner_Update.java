...
public class CarOwner_Update {
    ...
    public class UpdateCarOwner_Inner extends JFrame {
        ...
        public UpdateCarOwner_Inner() {
            ...
            CNIC_Label = new JLabel("Enter Aadhar (without dashes)");
                        ...
                        if (CarOwner.isCNICValid(cnic)) {
                            ...
                            if (CO != null) {
                                if (cnic.equals(carOwner.getCNIC())) {
                                    ...
                                    cnic = null;
                                    JOptionPane.showMessageDialog(null, "This Aadhar No is already registered !");
                                }
                            } else { // when CarOwner.SearchCNIC(M) returned null
                                System.out.println("new AadharNO is entered");
                            }
                        } else {
                            cnic = null;
                            CNICValidity_Label.setText("Invalid AadharNo !");
                        }
                    } else {
                        cnic = null;
                        CNICValidity_Label.setText("Enter AadharNO !");
                    }
                    if (!name.isEmpty()) {
